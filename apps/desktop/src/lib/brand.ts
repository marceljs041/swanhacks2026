...
export const BRAND_QUIZ_HERO_URL = "/quiz.svg";
export const BRAND_FLASHCARD_HERO_URL = "/flashcard.svg";
export const BRAND_CLASS_HERO_URL = "/class.svg";
export const BRAND_ASKAI_HERO_URL = "/askai.svg";
/**
...
export const BRAND_AI_URL = "/askai.svg";
