 ...
 */
import { recordXp, upsertAttachment, upsertNote, } from "../db/repositories.js";
import { XP_RULES } from "@studynest/shared";
import { startAudioJob } from "./audioJobs.js";
const TRANSCRIBING_PLACEHOLDER = "_Transcribing recording with Gemma 4 — this note will fill in " +
    "automatically when the model finishes._";
export async function captureAudioToNote(opts) {
...
function deriveInitialTitle(fileName) {
