...
async function decodeToMono16k(blob) {
    ...
    try {
        ...
        decoded = await new Promise((resolve, reject) => {
            const maybePromise = decodeCtx.decodeAudioData(arrayBuf.slice(0), (b) => resolve(b), (e) => reject(e ?? new Error("decode failed")));
 ...
 */
export async function chunkAudioFor30s(blob) {
...
//# sourceMappingURL=audioChunks.js.map